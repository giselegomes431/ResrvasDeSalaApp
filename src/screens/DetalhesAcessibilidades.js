...
export default function DetalhesAcessibilidades({ navigation, route }) {
            ...
            >
                ...
                <View style={styles.formContext}>
                    ...
                    <View style={styles.navbar2}>
                        {espaco.acessibilidades.map((acessibilidades, index) => (
                            <Text key={index} style={styles.list}>• {acessibilidades}</Text>
                        ))}
                    </View>
